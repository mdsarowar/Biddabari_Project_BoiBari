...
//            return 'sarowar12';
//            session()->forget('bkash_token', $response['id_token']);
//            session()->forget('bkash_token_type', $response['token_type']);
//            session()->forget('bkash_refresh_token', $response['refresh_token']);
...
//        return $this->baseUrl.$url;
        ...
        $url = curl_init($this->baseUrl.$url);
//        $requestbodyJson = json_encode($data);
//        return gettype($requestbodyJson);
        $header = array(
            'Content-Type:application/json',
            "authorization: $token",
            "x-app-key: $app_key"
