    ...
    <div class="floating-container ">
        <div class="floating-button ">
            <a  href="<?php echo e(url('cart')); ?>" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="<?php echo e(__('Cart')); ?>">
                ...
                <span class="topbar-action-badge cart_count position-absolute top-0 start-60 "  id="cart_amountbody">
                    <?php
                    if(Auth::check()){
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="login-tab-pane" role="tabpanel" aria-labelledby="login-tab" tabindex="0">
                                <div class="login-block">
                                    ...
                                    <form novalidate id="loginform" method="POST" class="form register-form outer-top-xs" role="form" action="<?php echo e(route('normal.login')); ?>">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <?php else: ?>
                                            <div class="mb-3">
                                                <label for="exampleInputmobile" class="form-label"><?php echo e(__('Mobile')); ?><span class="required">*</span></label>
                                                <input required type="text" name="mobile" class="form-control <?php echo e($errors->has('mobile') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('mobile')); ?>" autofocus id="exampleInputmobile" aria-describedby="mobilehellp">
                                            ...
                                            <div class="mb-3">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-6">
                                                        <label for="exampleInputPassword1" class="form-label"><?php echo e(__('Password')); ?><span class="required">*</span></label>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-6">
                                      ...
                                      <strong><?php echo e($errors->first('password')); ?></strong>
                                            ...
                                            <div class="mb-3 form-check">
                                                <input type="checkbox" class="form-check-input" id="loginexampleCheck1" name="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>>
                                                <label class="form-check-label" for="loginexampleCheck1"><?php echo e(__('Remember Information')); ?></label>
                                            </div>
                                ...
                                <div class="login-block">
                                    <form role="form" method="POST" action="<?php echo e(route('register')); ?>" novalidate>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleInputName2" class="form-label"><?php echo e(__('Name')); ?><span class="required">*</span></label>
                                      ...
                                      <strong><?php echo e($errors->first('email')); ?></strong>
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleInputphonecode2" class="form-label"><?php echo e(__('Mobile No.')); ?><span class="required">*</span></label>
                                                <input required pattern="[0-9]+" title="<?php echo e(__('Please enter valid mobile no')); ?>." value="<?php echo e(old('mobile')); ?>" type="text" class="form-control <?php echo e($errors->has('mobile') ? ' is-invalid' : ''); ?>" name="mobile"  required autofocus>
                                                <?php if($errors->has('mobile')): ?>
                                                    <span class="invalid-feedback" role="alert">
                                        <strong><?php echo e($errors->first('mobile')); ?></strong>
                                    </span>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select hidden="hidden" name="type" data-placeholder="<?php echo e(__("Please choose customer type")); ?>" class="form-control select2">
                                        ...
                                        <strong><?php echo e($errors->first('type')); ?></strong>
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleInputPassword2" class="form-label"><?php echo e(__('Password')); ?><span class="required">*</span></label>
                                      ...
                                      <strong><?php echo e($errors->first('password')); ?></strong>
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleInputPassword3" class="form-label"><?php echo e(__('Confirm Password')); ?><span class="required">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <?php endif; ?>
                                            <div class="mb-3 form-check">
                                                <input type="checkbox" class="form-check-input text-dark" name="eula" id="signupexampleCheck1">
                                                <label class="form-check-label text-danger" for="signupexampleCheck1">I agree with the terms & conditions.</label>
                                            </div>
                                            <input type="submit" value="Sign Up" class="form-control btn btn-primary text-light">
                        ...
                        <div class="login-block">
                            ...
                            <?php else: ?>
                                <form method="POST" action="<?php echo e(route('password.email')); ?>">
                                    ...
                                    <div class="social-login-block">
                                        <div class="mb-3">
                                            <div id="emailHelp" class="form-text mb-3">Enter your email address or mobile
                                                number to reset password.
                                            </div>
                                            <label for="exampleInputEmail1" class="form-label">E-mail*</label>
                                            <input required="" value="<?php echo e(old('email')); ?>" type="email" name="email"
...
<script type="text/javascript" src="<?php echo e(url('frontend/assets/vendor/owl_carousel/js/owl1.carousel.min.js')); ?>"></script> <!-- owl carousel js-->
...
<script>
    $('.add_in_wish_simple').on('click',function(){
        ...
        $(this).parent().html('<a class="add_in_wish_simple add-wishlist" data-proid="' + proid + '" data-bs-status="<?php echo e(inwishlist(' + proid + ')); ?>" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="<?php echo e(__('Wishlist')); ?>" href="javascript:void(0)"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg></a>');
        $.ajaxSetup({
            headers: {
...
</html><?php /**PATH D:\xampp\htdocs\boibari\resources\views/frontend/layout/master.blade.php ENDPATH**/ ?>