...
<?php $__env->startSection('title',__('Create a Publisher')); ?>
    ...
    <div class="col-lg-12">
      ...
      <div class="card m-b-30">
        ...
        <div class="card-header">
          ...
          <div class="row">
            <div class="col-lg-10">
                <h5 class="card-title"> <?php echo e(__("Add Publishers")); ?></h5>
            </div>
            <div class="col-md-2">
              <div class="widgetbar">
        ...
        <div class="card-body">
          ...
          <form id="demo-form2" method="post" enctype="multipart/form-data" action="<?php echo e(route('publisher.store')); ?>" data-parsley-validate class="form-horizontal form-label-left">
            <?php echo e(csrf_field()); ?>

            
            <div class="row">
              <div class="form-group col-md-6">
                <label class="control-label text-dark" for="first-name"> <?php echo e(__('Publisher')); ?>: <span class="required">*</span></label>
                <input placeholder="<?php echo e(__('Please enter Publisher name')); ?>" type="text" id="first-name" name="title" class="form-control col-md-12" value="<?php echo e(old('title')); ?>">
              </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master-soyuz', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\boibari\resources\views/admin/publisher/add.blade.php ENDPATH**/ ?>