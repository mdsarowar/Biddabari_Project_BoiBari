                            ...
                            <div class="topbar-sidenav">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="menu-tab-pane" role="tabpanel" aria-labelledby="menu-tab" tabindex="0">
                                        <ul class="navbar-nav">
                                            <li class="nav-item">
                                                <a class="nav-link dropdown-toggle text-dark" href="#" data-bs-toggle="dropdown" title="<?php echo e(__('Categories')); ?>"><i data-feather="award"></i><?php echo e(__('All Categories')); ?></a>
                                                <ul class="dropdown-menu">
                                                    <?php $__currentLoopData = App\Category::where('status','1')->latest()->paginate(7); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li>
                                            ...
                                            <?php else: ?>
                                            <li class="nav-item">
                                                <a class="nav-link" href="<?php echo e(route('user_login')); ?>" title="Login"><i data-feather="log-out"></i><?php echo e(__('Login')); ?></a>
                                                <a class="nav-link" href="<?php echo e(route('user_register')); ?>" title="Register"><i data-feather="user"></i><?php echo e(__('Register')); ?></a>
                                            </li>
                                            <?php endif; ?>
                    ...
                    <div class="row sticky">
                        <ul class="navbar-nav">
                            <li class="nav-item active col-md-2">
                                <a  class="form-select text-dark " href="#" data-bs-toggle="dropdown" title="<?php echo e(__('Categories')); ?>" ><?php echo e(__('All Categories')); ?> </a>
                                <ul class="dropdown-menu ">
                                    <?php $__currentLoopData = App\Category::where('status','1')->latest()->paginate(7); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li >
                                            <a class="dropdown-item" href="javascript:" onclick="changeCategory(<?php echo e($cat->id); ?>,'main')" title="<?php echo e($cat->title); ?>">
