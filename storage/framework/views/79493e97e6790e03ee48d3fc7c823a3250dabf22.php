...
<?php $__env->startSection('title','BoiBari | Checkout'); ?>
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <div class="py-30">
                                            ...
                                            ?>
                                            <h4 class="text-success pb-2">Your Shipping Address store successfully => <span class="fs-6 text-info"><?php echo e($biladd->getdivisions->bn_name); ?> => <?php echo e($biladd->getdistrict->bn_name); ?> => <?php echo e($biladd->getupazila->bn_name); ?> => <?php echo e($biladd->getunion->bn_name); ?></span></h4>
                                            ...
                                            <form action="<?php echo e(route('choose.address')); ?>" method="post">
                                                ...
                                                <?php if(count($addresses)): ?>
                                                    <div class="form-check mb-3">
                                                        <input class="form-check-input " type="radio" name="seladd" checked="checked" value="<?php echo e($addresses[0]->id); ?>" id="flexRadioDefault1">
                                                    ...
                                                    <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($key > 0): ?>
                                                            <div class="form-check">
                                                                <input class="form-check-input " type="radio" name="seladd"  value="<?php echo e($address->id); ?>" id="flexRadioDefault<?php echo e($address->id); ?>">
                                                                <label class="form-check-label" for="flexRadioDefault<?php echo e($address->id); ?>">
                                            ...
                                            <div class="row mb-30">
                                                <div class="col-lg-4">
                                                    <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                        ...
                                                        <a class="nav-link" id="v-pills-bkash-tab" data-bs-toggle="pill" href="#v-pills-bkash" type="button" role="tab" aria-controls="v-pills-bkash" aria-selected="false"><?php echo e(__('Pay Via Bkash')); ?></a>
                                                                        ...
                                                                        <?php if(pre_order_disable() == false): ?>
                                                                            ...
                                                                            <form action="<?php echo e(route('manualpay.checkout',['token' => $token, 'payvia' => $item->payment_name])); ?>" method="POST" enctype="multipart/form-data">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <label for="">Enter your <?php echo e($item->payment_name); ?> number <span class="text-red">*</span> </label>
                                                                                    <input required title="Please Enter your account number" type="text" class="<?php $__errorArgs = ['purchase_proof'];
...
unset($__errorArgs, $__bag); ?> form-control mt-3 mb-3" name="purchase_number"/>
