        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <h5 class="card-title"> <?php echo e(__("All Authors")); ?></h5>
                    </div>
                    <div class="col-md-6">
                      <div class="widgetbar">


                        <a href="<?php echo e(route('author.create')); ?> " class="btn btn-primary-rgba mr-2">
                            <i class="feather icon-plus mr-2"></i> <?php echo e(__("Add Author")); ?>
                ...
                <table id="full_detail_table" class="cattable w-100 table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php $__currentLoopData = $authors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $aut): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="row1" data-id="<?php echo e($aut->id); ?>">
                      
                      <td><?php echo e(++$key); ?></td>

                      <td>
                        <?php if($aut->image != '' && file_exists(public_path().'/images/Author/'.$aut->image) ): ?>
                        <img class="pro-img mr-2" align="left" src="<?php echo e(url('images/Author/'.$aut->image)); ?>" title="<?php echo e($aut->title); ?>">
                        <?php else: ?>
                        <img class="pro-img mr-2" align="left" title="<?php echo e($aut->title); ?>" src="<?php echo e(Avatar::create($aut->title)->toBase64()); ?>" />
                        <?php endif; ?>
                      </td>
                      
                      <td> <?php echo e($aut->title); ?> </td>
                      
                      <td>
                        
                        <p><b><?php echo e(__('Name')); ?>: </b><span class="font-weight500"><?php echo e($aut->title); ?></span></p>
                        <p><b><?php echo e(__('Description')); ?>: </b><span class="text-justify font-weight500"><?php echo e(substr(strip_tags($aut->description), 0, 100)); ?><?php echo e(strlen(strip_tags(
                           $aut->description))>100 ? '...' : ""); ?></span></p>
                      </td>
            
                      <td>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('category.edit')): ?>
                        <form method="POST" action="<?php echo e(route('cat.quick.update',$aut->id)); ?>">
                          <?php echo e(csrf_field()); ?>

                          <button <?php if(env('DEMO_LOCK')==0): ?> type="submit" <?php else: ?> title="<?php echo e(__("This operation is disabled in Demo !")); ?>"
                            disabled="" <?php endif; ?> class="btn btn-sm btn-rounded <?php echo e($aut->status ==1 ? 'btn-success-rgba' : 'btn-danger-rgba'); ?>">
                            <?php echo e($aut->status==1 ? __('Active') : __('Deactive')); ?>
                      ...
                      <td>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('category.edit')): ?>
                        <form method="POST" action="<?php echo e(route('cat.featured.quick.update',$aut->id)); ?>">
                          <?php echo e(csrf_field()); ?>

                          <button <?php if(env('DEMO_LOCK')==0): ?> type="submit" <?php else: ?> title="<?php echo e(__("This operation is disabled in Demo !")); ?>"
                            disabled="" <?php endif; ?> class="btn btn-sm btn-rounded <?php echo e($aut->featured ==1 ? 'btn-success-rgba' : 'btn-danger-rgba'); ?>">
                            <?php echo e($aut->featured==1 ? 'Yes' : 'No'); ?>
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('category.edit')): ?>
                              <a class="dropdown-item" href="<?php echo e(route('author.edit',$aut->id)); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__("Edit")); ?></a>
                              <?php endif; ?>
          
                              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('category.delete')): ?>
                              <a class="dropdown-item btn btn-link" data-toggle="modal" data-target="#delete<?php echo e($aut->id); ?>" >
                                <i class="feather icon-delete mr-2"></i><?php echo e(__("Delete")); ?></a>
                            </a>
                              <?php endif; ?>
                          </div>
                      </div>
                      <div class="modal fade bd-example-modal-sm" id="delete<?php echo e($aut->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form method="post" action="<?php echo e(route('author.destroy',$aut->id)); ?>" class="pull-right">
                                        <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('admin.layouts.master-soyuz', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\boibari\resources\views/admin/author/index.blade.php ENDPATH**/ ?>