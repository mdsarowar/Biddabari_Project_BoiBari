...
<?php $__env->startSection('title',__('Admin Custom Color |')); ?>
<?php $__env->startSection('body'); ?>

<?php
  $data['heading'] = 'Admin Custom Color';
  $data['title0'] = 'Setting';
  $data['title1'] = 'Admin Custom Color';
?>
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box"><?php echo e(__('Admin Customisation')); ?></h5>
                </div>
                <!-- card body started -->
                <div class="card-body">
                    <!-- form start -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    <a href="<?php echo e(route('admincustomisation.reset')); ?>" type="reset" class="btn btn-danger-rgba mr-1"><i class="fa fa-ban"></i> <?php echo e(__("Reset")); ?></a>
...
<?php echo $__env->make('admin.layouts.master-soyuz', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\boibari\resources\views/admin/admincustomisation/view.blade.php ENDPATH**/ ?>