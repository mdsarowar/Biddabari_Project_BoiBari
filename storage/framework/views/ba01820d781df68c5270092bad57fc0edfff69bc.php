...
<?php $__env->startSection('title',__("Edit Publisher | ")); ?>
    ...
    <div class="col-lg-12">
      ...
      <div class="card m-b-30">
        ...
        <div class="card-header">
          ...
          <div class="row">
            <div class="col-lg-10">
                <h5 class="card-title"> <?php echo e(__("Edit Publisher")); ?></h5>
            </div>
            <div class="col-md-2">
              <div class="widgetbar">
                <a href="<?php echo e(route('publisher.index')); ?>" class="btn btn-primary-rgba"><i class="feather icon-arrow-left mr-2"></i><?php echo e(__("Back")); ?></a>
              </div>
            </div>
          </div>
        ...
        <div class="card-body">
          <!-- Start Form -->
          <form id="demo-form2" method="post" enctype="multipart/form-data" action="<?php echo e(route('publisher.update',$publisher->id)); ?>" data-parsley-validate class="form-horizontal form-label-left">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                ...
                <input placeholder="<?php echo e(__('Please enter Author name')); ?>" type="text" id="first-name" name="title" value="<?php echo e($publisher->title); ?>" class="form-control col-md-12">
              </div>
              ...
              <div class="form-group col-md-6">
                ...
                <div class="input-group">
                  ...
                  <div class="mb-2">
                      <?php if(@file_get_contents('images/Publishers/'.$publisher->image)): ?>
                      <img width="100px" id="image-pre" class="img-fluid bg-primary-rgba p-3" src=" <?php echo e(url('images/Publishers/'.$publisher->image)); ?>">
                      <?php else: ?>
                      <img title="<?php echo e($publisher->title); ?>" id="image-pre" class="pro-img" src="<?php echo e(Avatar::create($publisher['title'])->toBase64()); ?>" />
                      <?php endif; ?>
                    </div>
              </div>
              ...
              <div class="form-group col-md-12">
                ...
                <textarea cols="2" id="editor1" name="description" rows="5"> <?php echo e(ucfirst($publisher->description)); ?></textarea>
              </div>

              <div class="form-group col-md-6">
                <label class="control-label text-dark" for="first-name"> <?php echo e(__("Featured:")); ?></label><br>
                <label class="switch">
                  <input class="slider tgl tgl-skewed" name="featured" type="checkbox" id="toggle-event33" <?php echo e($publisher->featured ==1 ? "checked" : ""); ?>>
              ...
              <div class="form-group col-md-6">
                ...
                <label class="switch">
                  <input class="slider tgl tgl-skewed" type="checkbox" id="toggle-event33" <?php echo e($publisher->status ==1 ? "checked" : ""); ?>>
                  <span class="knob"></span>
                  <input type="hidden" name="status" value="<?php echo e($publisher->status); ?>" id="status3">
                </label>
                <br>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master-soyuz', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\boibari\resources\views/admin/publisher/edit.blade.php ENDPATH**/ ?>