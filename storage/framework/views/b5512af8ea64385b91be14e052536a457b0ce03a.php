                ...
                <div id="aniBox" class="col-md-6 col-sm-12 sign-in">
                    ...
                    <?php else: ?>
                        ...
                        <form novalidate id="loginform" method="POST" class="form register-form outer-top-xs" role="form"
                            action="<?php echo e(route('normal.login')); ?>">
                            <?php echo csrf_field(); ?>

                            <div class="form-group">
                                <label class="info-title" for="exampleInputPhone"><?php echo e(__('Mobile')); ?>

                                    <span>*</span></label>
                                <input required type="number" name="mobile"
                                    class="form-control unicase-form-control text-input <?php echo e($errors->has('mobile') ? ' is-invalid' : ''); ?>"
                                    id="mobile" value="<?php echo e(old('mobile')); ?>" required autofocus>
                            ...
                            <div class="radio outer-xs form-check">
                                ...
                                <span class="float-right">New User ?
                                     <a href="<?php echo e(route('register')); ?>"
                                        class="forgot-password text-info "><?php echo e(__(' Register Now')); ?></a>
                                </span><br>
                                <span class="float-right">Forgot Your
                                      <a href="<?php echo e(route('password.request')); ?>"
                                         class="forgot-password text-info"><?php echo e(__(' Password')); ?></a>
                                </span>
